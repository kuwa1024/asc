...
@DisplayName("ProductGetRequestのユニットテスト")
public class ProductGetRequestTest {
    ...
    class ValidationTests {
        ...
        void testValidation_Success() {
            ProductGetRequest request = new ProductGetRequest(UUID.randomUUID().toString());
            Set<ConstraintViolation<ProductGetRequest>> violations = validator.validate(request);
        ...
        void testValidation_withInvalidId_thenError(String invalidId, String displayName) {
            ProductGetRequest request = new ProductGetRequest(invalidId);
            Set<ConstraintViolation<ProductGetRequest>> violations = validator.validate(request);
